...
localStorage.getItem("dataDevelopers")?(s=JSON.parse(localStorage.getItem("dataDevelopers")),console.log("Дані списку розробників взяті з LocalStorage",s)):(console.log("Створюємо дефолтний список розробників"),localStorage.setItem("dataDevelopers",JSON.stringify(s)));const t=s.map(e=>`<li class="team__item">
                ...
                />
                    ...
                    ${e.images.mobile[2]} 3x
					  ...
					  <p class="team__text">${e.name}</p>
					  <h3 class="team__position">${e.position}</h3>
					...
					</li>`).join("");o.innerHTML=t;console.log("Наші розробники:",s);console.log("Розмітка списку розробників:",t);
